...
2.1 Gestione delle eccezioni multi-livello
   ...
   2.1.2 Gestione delle eccezioni a più livelli

2.2 Risorsa Automatica di Chiusura (try-with-resources)
   2.2.1 Introduzione al try-with-resources
   2.2.2 Implementazione e utilizzo
